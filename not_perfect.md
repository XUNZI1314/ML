...
20. [已完成基础增强] 补多运行趋势与 run-to-run 差异解释。
21. [未完成] 如果后续需要，再继续推进成“单个 exe 也能完全独立”的完整便携版。
...
19. [已完成基础增强] 在本地交互壳中补多运行趋势与 run-to-run 差异解释。
20. [未完成] 如果后续需要，再把桌面程序从“整个目录便携”推进到“单个 exe 完全独立”。
