...
- Open the repair plan CSV for exact missing paths: `D:\minimal_ML_test\benchmarks\cd38\external_tool_inputs\finalize\import_gate\preimport_dry_run\cd38_external_tool_output_import_repair_plan.csv`.

## Outputs

- Import manifest: `D:\minimal_ML_test\benchmarks\cd38\external_tool_inputs\finalize\import_gate\preimport_dry_run\cd38_external_tool_output_import_manifest.csv`
- Scan manifest: `D:\minimal_ML_test\benchmarks\cd38\external_tool_inputs\finalize\import_gate\preimport_dry_run\cd38_external_tool_output_import_scan.csv`
- Coverage manifest: `D:\minimal_ML_test\benchmarks\cd38\external_tool_inputs\finalize\import_gate\preimport_dry_run\cd38_external_tool_output_import_coverage.csv`
- Repair plan: `D:\minimal_ML_test\benchmarks\cd38\external_tool_inputs\finalize\import_gate\preimport_dry_run\cd38_external_tool_output_import_repair_plan.csv`
- Summary JSON: `D:\minimal_ML_test\benchmarks\cd38\external_tool_inputs\finalize\import_gate\preimport_dry_run\cd38_external_tool_output_import_summary.json`
