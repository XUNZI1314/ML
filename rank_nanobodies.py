...
def aggregate_nanobody_scores(
    ...
    for nanobody_id, g in conformer_df.groupby("nanobody_id", sort=False):
        ...
        for col in [
            ...
            "mean_topk_catalytic_anchor_core_residue_count",
            "mean_topk_catalytic_anchor_primary_shell_residue_count",
            "mean_topk_catalytic_anchor_primary_shell_fraction_of_antigen",
            "mean_topk_catalytic_anchor_primary_shell_hit_fraction",
            "mean_topk_catalytic_anchor_min_distance_to_primary_shell",
            "mean_topk_catalytic_anchor_manual_overlap_fraction_of_shell",
            "mean_topk_catalytic_anchor_shell_overwide_proxy",
            "mean_topk_catalytic_anchor_shell_overwide_flag",
            "mean_topk_catalytic_anchor_shell_4A_hit_fraction",
            "mean_topk_catalytic_anchor_shell_6A_hit_fraction",
            "mean_topk_catalytic_anchor_shell_8A_hit_fraction",
